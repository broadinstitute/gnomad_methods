...
def get_sex_expr(
    ...
    """
    def get_ploidy_cutoffs(ht: hl.Table, f_stat_cutoff: float, lower_SD_cutoff: int, upper_SD_cutoff: int) -> dict:
        """
    ...
    cutoffs = get_ploidy_cutoffs(ht, f_stat_cutoff, lower_SD_cutoff, upper_SD_cutoff)
