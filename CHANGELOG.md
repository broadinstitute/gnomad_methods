...
* Fix to `make_combo_header_text` to correctly return description text if 'gnomad' is in prefix, even if `combo_dict` only contains the group `adj` [(#348)](https://github.com/broadinstitute/gnomad_methods/pull/348)
