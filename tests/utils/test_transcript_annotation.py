...
class TestCreateTxAnnotationByRegion:
    ...
    def sample_hail_table(self) -> hl.Table:
        ...
        return hl.Table.parallelize(
            [
                {"locus": hl.Locus("chr1", 1), "gene_id": "gene1", "exp_prop_mean": 0.5,
                 "tissue1": 0.2, "tissue2": 0.3},
                {"locus": hl.Locus("chr1", 2), "gene_id": "gene1", "exp_prop_mean": 0.5,
                 "tissue1": 0.2, "tissue2": 0.3},
                {"locus": hl.Locus("chr1", 3), "gene_id": "gene1", "exp_prop_mean": 0.6,
                 "tissue1": 0.3, "tissue2": 0.4},
                {"locus": hl.Locus("chr1", 4), "gene_id": "gene2", "exp_prop_mean": 0.7,
                 "tissue1": 0.5, "tissue2": 0.6},
                {"locus": hl.Locus("chr1", 5), "gene_id": "gene2", "exp_prop_mean": 0.7,
                 "tissue1": 0.5, "tissue2": 0.6},
                {"locus": hl.Locus("chr1", 6), "gene_id": "gene2", "exp_prop_mean": 0.8,
                 "tissue1": 0.6, "tissue2": 0.7},
            ],
            hl.tstruct(
                locus=hl.tlocus(), gene_id=hl.tstr, exp_prop_mean=hl.tfloat64,
                tissue1=hl.tfloat64, tissue2=hl.tfloat64
            ),
        ).key_by("locus").annotate_globals(tissues=["tissue1", "tissue2"])
