...
def get_checkpoint_path(gnomad: bool, data_type: str),  -> str:
    """
    ...
    dtype = f'_{data_type}_' if data_type else ''
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--table', help='Full path to table for liftover')
    parser.add_argument('-g', '--gnomad', help='Liftover table is one of the gnomAD releases')
    parser.add_argument(
            '--exomes', 
